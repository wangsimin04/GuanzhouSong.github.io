---
layout: post
title:  The Way To Go 第二部分：语言的核心结构与技术
date:   0000-02-02 12:00:00 +0000
categories: 不周山
tag: Go
---
...
下面的代码片段（示例 4.9 [pointer.go](files/Go/examples/chapter_4/pointer.go)）可能输出 `An integer: 5, its location in memory: 0x6b0820`（这个值随着你每次运行程序而变化）。
...
示例 4.23 [testcrash.go](/files/Go/examples/chapter_4/testcrash.go):
